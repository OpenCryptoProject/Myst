...
public class DKG {
    ...
    private short CARD_INDEX_THIS = -1;   // index of player realised by this card // TODO: add check for setShares methods not to overwrite data of this player
...
*/        
    ...
    public void SetHash(short id, byte[] hash, short hashOffset, short hashLength) {
        if (id < 0 || id == CARD_INDEX_THIS || id >= N_PLAYERS) {
